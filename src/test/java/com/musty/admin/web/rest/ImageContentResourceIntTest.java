...
public class ImageContentResourceIntTest {
    ...
    public void createImageContent() throws Exception {
        ...
        assertThat(testImageContent.getSubscriptionType()).isEqualTo(DEFAULT_SUBSCRIPTION_TYPE);
    ...
    public void updateImageContent() throws Exception {
        ...
        assertThat(testImageContent.getSubscriptionType()).isEqualTo(UPDATED_SUBSCRIPTION_TYPE);
